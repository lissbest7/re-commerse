          ...
          {({ values, handleChange, handleBlur, isSubmitting }) => (
            <Form>
              <div className="relative w-full mb-4">
                ...
                <label
                  htmlFor="title"
                  className="absolute text-sm text-gray-500 duration-300 transform scale-75 top-1 left-2.5 origin-[0] bg-white px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4"
                >
                  Title
                </label>
                <ErrorMessage
